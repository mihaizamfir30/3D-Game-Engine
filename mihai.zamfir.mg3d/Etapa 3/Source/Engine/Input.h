...
class Input
{
	...
	public:
		...
		static void SetResolution(glm::ivec2 resolution);

		static bool GetKey(KeyCode key);
		static bool GetKeyUp(KeyCode key);
		static bool GetKeyDown(KeyCode key);

		static void OnInputStart();
		static void OnInputEnd();
	...
	private:
		...
		//static bool isKeyPressed[500];
		//static bool isKeyPressedPrev[500];

		static int keyState[500];
		static int keyStatePrev[500];

		static glm::vec2 mousePosition;
		static glm::vec2 mouseScroll;

		//double xPos, xPos;
		static double xPosPrev, yPosPrev;
